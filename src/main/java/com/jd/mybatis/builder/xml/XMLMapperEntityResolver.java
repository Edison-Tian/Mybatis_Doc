...
public class XMLMapperEntityResolver implements EntityResolver {
  ...
  private static final String MYBATIS_CONFIG_DTD = "com/jd/mybatis/builder/xml/mybatis-3-config.dtd";
  private static final String MYBATIS_MAPPER_DTD = "com/jd/mybatis/builder/xml/mybatis-3-mapper.dtd";
