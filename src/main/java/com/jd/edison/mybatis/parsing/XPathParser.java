 ...
 */
package com.jd.edison.mybatis.parsing;
...
/**
 * XpathParser的作用是通过构造函数等一系列方法，将配置文件解析为可任意读取的Document对象，
 * 以供后面操作。
...
public class XPathParser {
	...
	/**
	 * @param reader         配置文件
	 * @param validation     是否需要验证XML中的DTD信息
	 * @param variables
	 * @param entityResolver DTD校验器
	 */
	...
	/**
	 * <p>解析配置文件:将配置文件解析为Document对象</p>
	 * <p><strong>由于此方法依赖于validation和entityResolver这2个属性，所以必须在commonConstructor之后才可以调用</strong></p>
	 *
